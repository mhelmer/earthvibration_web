...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.path.dirname(PROJECT_DIR), 'db.sqlite3'),  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'quf#xj*4z7-j1%es%(r%iz+e^_4*0g+(^08uf=3g2ff^qz2=5+'
